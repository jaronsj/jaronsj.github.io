window.addEventListener('load', () =>{
    const weatherURL = 'https://api.openweathermap.org/data/2.5/weather?zip=83276,us&appid=bc0f5b4b03b1172429a1ac3fd29e6dcc&units=imperial';
    fetch(weatherURL)
    ...
    const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?zip=83276,us&appid=bc0f5b4b03b1172429a1ac3fd29e6dcc&units=imperial';
        fetch(forecastURL)
        .then((response) => response.json())
        .then((jsObject) => {
            console.log(jsObject);
